...
## Post-Approval: Rename Branch

Worktree sessions auto-assign a `claude/<slug>` branch name. Immediately after plan approval, rename it to `dev/<feature-slug>` before writing any code:
